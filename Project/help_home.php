    ...
    <div class="container">
        ...
        <div class="wrapper wrapper--w900">
			...
			if (isset($_POST['send']))
				...
				$q1 = mysqli_query($mysqli, "INSERT INTO patient_details ( patient_id,patient_de_name, patient_de_lastname, patient_de_age, patient_de_con, patient_de_details,  patient_de_address )
				VALUES ('$pid','$name','$lastname','$age','$con', '$details','$address')");
				
				//$q2 = mysqli_query($mysqli, "INSERT INTO stock ( product_id, qty) VALUES ('$product_code','$qty')");
                                
                                 $t_sql = "UPDATE patient_details SET patient_date=CURRENT_TIMESTAMP WHERE patient_id = '$pid'";
